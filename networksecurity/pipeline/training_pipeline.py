...
class TrainingPipeline:
    ...
    def start_data_ingestion(self):
        try:
            ...
            data_ingestion=DataIngestion(data_ingestion_config=self.data_ingestion_config) #object
    ...
    def start_data_validation(self,data_ingestion_artifact:DataIngestionArtifact):
        try:
            ...
            data_validation=DataValidation(data_ingestion_artifact=data_ingestion_artifact,data_validation_config=data_validation_config) #object
    ...
    def start_data_transformation(self,data_validation_artifact:DataValidationArtifact):
        try:
            ...
            data_transformation_config=data_transformation_config) #object
    ...
    def start_model_evaluation(self,data_validation_artifact:DataValidationArtifact,
        ...
        try:
            ...
            model_eval=ModelEvaluation(model_evaluation_config,data_validation_artifact,model_trainer_artifact) #object
            model_eval_artifact=model_eval.initiate_model_evaluation() #calls method and gives artifact
