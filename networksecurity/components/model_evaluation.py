...
class ModelEvaluation:
    def __init__(self,model_eval_config:ModelEvaluationConfig,
        ...
        try:
            self.model_eval_config=model_eval_config #object variable
            self.data_validation_artifact=data_validation_artifact #object variable
    ...
    def initiate_model_evaluation(self)->ModelEvaluationArtifact:
        try:
            ...
            if not model_resolver.is_model_exists(): # if model not i =n directory
            ...
            latest_model = load_object(file_path=latest_model_path) #current model
            train_model = load_object(file_path=train_model_file_path) #modl recently trained
            ...
            improved_accuracy = trained_metric.f1_score-latest_metric.f1_score #0.03
